...
// import cors from "cors"; // DEPRECATO - Spostato su Nginx
import fs from 'fs';
import https from "https";
import morgan from "morgan";
import { createStream } from "rotating-file-stream";
import rateLimit from "express-rate-limit";
// import helmet from 'helmet'; // DEPRECATO - Spostato su Nginx
...
// --- SETUP CORS
/* DEPRECATO - Gestito centralmente da Nginx (Single Point of Entry)
 a pp*.use(cors({
...
/* deprecato - CSP e security headers spostati su Nginx
 a pp*.use(helmet());      // helmet di base applica di default header come X-Content-Type-Options: nosniff
